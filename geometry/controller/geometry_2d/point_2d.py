# -*- coding: utf-8 -*-
from geometry.controller.common.common import checkSign
import math

class Point2D(object):

    def __init__(self, x, y, rowid=-1):
        '''
    ...
    def polarCoordinate(self):
        '''
        Metodo que obtiene el angulo en grados de la coordenada polar de un punto en
        dos dimensiones a partir de sus coordenadas "x" e "y".
        '''
        '''
